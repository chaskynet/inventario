...
class Almacenes_model extends CI_Model{
	...
	public function nuevo_almacen($almacen){
		...
		$query_almacen = $this->db->query("INSERT INTO almacen (id_almacen, nombre_almacen, abreviacion, direccion, fono, fecha) values ('', '$nuevo_almacen->nombre_almacen', '$nuevo_almacen->abreviacion', '$nuevo_almacen->direccion', '$nuevo_almacen->telefono', now())");
  ...
  // 							MODIFY `id_inventario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;");
	...
	public function actualizar_almacen($almacen){
		$nuevo_almacen = json_decode($almacen);
		$query = $this->db->query("UPDATE almacen SET  nombre_almacen = '$nuevo_almacen->nombre_almacen', abreviacion = '$nuevo_almacen->abreviacion', direccion = '$nuevo_almacen->direccion', fono = '$nuevo_almacen->telefono' WHERE id_almacen = $nuevo_almacen->id_almacen");
